...
TEXTS = {
    'es': {
        ...
        'btn_reorder_tracks': "Ordenar (BPM/Artista)",
        'desc_reorder_tracks': "Ordena una playlist por BPM (tempo) o mueve artistas específicos al final.",
        'btn_mood_sort': "Clasificar por Mood",
        'desc_mood_sort': "Clasifica canciones en Uplifting, Melancholic o Deep Focus usando Valence y Energy.",
        'btn_trend_reports': "Informe de Tendencias",
        'desc_trend_reports': "Genera un informe detallado de tus géneros más escuchados y perfil de audio.",
    ...
    'en': {
        ...
        'btn_reorder_tracks': "Sort (BPM/Artist)",
        'desc_reorder_tracks': "Sort a playlist by BPM (tempo) or move specific artists to the end.",
        'btn_mood_sort': "Mood Sort",
        'desc_mood_sort': "Classify songs into Uplifting, Melancholic, or Deep Focus using Valence and Energy.",
        'btn_trend_reports': "Trend Reports",
        'desc_trend_reports': "Generate a detailed report of your top genres and audio profile.",
...
class SpotifyToolkitApp(ctk.CTk):
    ...
    def show_organize(self):
        ...
        tools = [
            ...
            (T['btn_mood_sort'], T['desc_mood_sort'], "mood_sort/mood_sort.py"),
